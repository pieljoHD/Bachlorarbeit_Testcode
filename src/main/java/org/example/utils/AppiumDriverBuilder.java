...
public class AppiumDriverBuilder {
    ...
    private URL getHubUrl() {
        ...
        try {
            ...
            Assert.fail("Exception message: ", e);
        }
    ...
    private DesiredCapabilities getIOSDefaultCapabilities(Simulator simulator) {
        ...
        capabilities.setCapability("appium:derivedDataPath","/Users/johannespielmeier/Library/Developer/Xcode/DerivedData/"+simulator.uuid);
